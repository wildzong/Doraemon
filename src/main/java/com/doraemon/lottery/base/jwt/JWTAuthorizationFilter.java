package com.doraemon.lottery.base.jwt;
...
/**
 * @Author: wildzong
 * @Description: JWTAuthorizationFilter用于登录成功后，进行鉴权操作
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(String tokenHeader) {
        ...
        // 从Token中解密获取用户名
        String username = JwtTokenUtil.getInfoByKey(token, "username");
        // 从Token中解密获取用户角色
        String role = JwtTokenUtil.getInfoByKey(token, "authorities");
